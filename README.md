...
Starting from `build-XX` we use Alpine 3.14 as our base image. This comes with security updates which may cause trouble as described in [Release Notes forAlpine 3.14.0 > faccessat2](https://wiki.alpinelinux.org/wiki/Release_Notes_for_Alpine_3.14.0#faccessat2).

In order to resolve this issue you can follow the workarounds provided here: [#32 (comment)](https://github.com/manios/docker-nagios/issues/32#issuecomment-940355201).
